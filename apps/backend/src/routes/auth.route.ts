...
import { emailCheck, login, logout, refreshToken, register, socialAuth, me, verifyAccount } from '../controllers/auth.controller';
...
authRouter.get('/me', some(every(setIpAddressToContext, isAuthenticated)), me);
